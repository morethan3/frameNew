...
import com.staging.frame.web.entity.autocreatetable.PageResultCommand;
import com.staging.frame.web.entity.autocreatetable.SaveOrUpdateDataCommand;
...
public class BaseMysqlCRUDManagerImpl implements BaseMysqlCRUDManager {
	...
	public <T> Integer save(T obj){
		...
		Map<Object, Map<Object, Object>> tableMap = new HashMap<>();
