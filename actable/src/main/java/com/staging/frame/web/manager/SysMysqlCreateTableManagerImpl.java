...
import com.staging.frame.web.annotation.LengthCount;
import com.staging.frame.web.annotation.Table;
import com.staging.frame.web.constants.AutoCreateTableConstant;
import com.staging.frame.web.constants.MySqlTypeConstant;
import com.staging.frame.web.dao.CreateMysqlTablesMapper;
import com.staging.frame.web.entity.autocreatetable.CreateTableParam;
import com.staging.frame.web.entity.autocreatetable.SysMysqlColumns;
import com.staging.frame.web.utils.ClassTools;
...
public class SysMysqlCreateTableManagerImpl implements SysMysqlCreateTableManager {
    ...
    public void createMysqlTable() {
        ...
        // 不做任何事情
        if (AutoCreateTableConstant.A_C_TABLE_AUTO_NONE.equals(tableAuto)) {
    ...
    void allTableMapConstruct(Map<String, Object> mySqlTypeAndLengthMap, Set<Class<?>> classes,
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    void createOrModifyTableConstruct(Map<String, List<Object>> newTableMap,
                                              Map<String, List<Object>> modifyTableMap, Map<String, List<Object>> addTableMap,
                                              Map<String, List<Object>> removeTableMap, Map<String, List<Object>> dropKeyTableMap,
